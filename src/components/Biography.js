...
const Biography = () => {
  ...
  <div className="text-container">
    ...
    Я с детства была в психологии и читала Карнеги, так как моя мама тоже психолог.
    ...
    Я поступила в университет при МЧС, так как хотела стать психологом именно в этой сфере.  
      ...
      Спустя 7 лет работы я все чаще начала испытывать выгорание, стресс и понимала, что этот род деятельности совсем не мой. Мне было страшно сделать какие-либо самостоятельные шаги в стороны изменений, поэтому я решила - иду в личную терапию, за помощью!
